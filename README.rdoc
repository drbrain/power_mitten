...
The control node coordinates shared resources such as mutexes and queues.
Alongside the control node is a Rinda:RingServer which other mitten services
to find each other.
...
state.  (If you start the console first it will wait for a control node.)
